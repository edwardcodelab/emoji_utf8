...
jQuery(function(){
    ...
    if($editForm.length) {
        jQuery.getJSON(DOKU_BASE + 'lib/plugins/emojiutf8/assets/emoji_strategy.json',
              function(emojiStrategy) {
                    ...
                    var langFooter = '<a href="https://www.emojicopy.com" target="_blank">&nbsp;' +
                                      LANG.plugins.emojiutf8.browseall +
                    ...
                    var emojiMap = {};
                    for (var key in emojiStrategy) {
                        var data = emojiStrategy[key];
                    ...
                    $editForm.textcomplete([{
                        ...
                        */
                        ...
                        template: function(obj) {
                            ...
                            // Alternative fallback to PNG if emoji not rendering:
                            // var fileName = assetUri + emojiStrategy[obj.shortname].unicode + '.png' + cacheBustParam;
                            // return '<img class="emojione" src="' + fileName + '"/> :' + obj.shortname + ':';
                        },
